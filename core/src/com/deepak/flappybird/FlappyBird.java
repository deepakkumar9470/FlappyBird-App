...
public class FlappyBird extends ApplicationAdapter {
	...
	public void create() {
		...
		background = new Texture("bg.png");//for backgroung image
		gameover = new Texture("gameover.png");
		birdCircle = new Circle();
		music= Gdx.audio.newMusic(Gdx.files.internal("point.mp3"));
		music.setLooping(true);
		music.setVolume(0.1f);
		music.play();

		font = new BitmapFont();//for fonts
		font.setColor(Color.WHITE);
		font.getData().setScale(10);

		birds = new Texture[2];
		birds[0] = new Texture("bird.png");//for bird image
		birds[1] = new Texture("bird2.png");

		topTube = new Texture("toptube.png");//for tubes images
